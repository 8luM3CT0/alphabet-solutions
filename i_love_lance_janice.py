...
# it’s not job-related – they’re both huge fans of the 
# space soap opera “Lance & Janice”. 
# You know how much Commander Lambda hates waste, 
# so if you can prove that these minions are wasting her time 
# passing non-job-related notes, it’ll put you that much closer to 
# a promotion.

#Fortunately for you, 
# the minions aren’t exactly advanced cryptographers. 
...
# For instance, the word “vmxibkgrlm”, when decoded, 
# would become “encryption”.

#Write a function called answer(s) which takes in a string and returns the 
# deciphered string so you can show the commander proof that these 
